    ...
    public partial class frmEspecialidade : Form
    {
        ...
        private void btnSair_Click(object sender, EventArgs e)
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja fechar o formulário de Especialização?",
                "Confirmação",
        ...
        {
            DialogResult resultado = MessageBox.Show(
              "Você tem certeza que deseja Limpar a tela de Especialidade?",
              "Confirmação",
              MessageBoxButtons.YesNo,
              MessageBoxIcon.Question
            );
        ...
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Excluir a Especialidade Selecionada?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
            ...
            var Delete = _context.Especialidade.Find(Id_);

            if (Delete != null)
            {
                _context.Especialidade.Remove(Delete);
            ...
            {
                MessageBox.Show("Especialidade não encontrado.");
            }
        }
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var entidade = _context.Especialidade.AsQueryable();
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Salvar a Especialidade?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
            ...
            var entityNew = new Especialidade();
            var entityUpdate = new Especialidade();

            if (txtId.Text.IsNullOrEmpty())
            {
                entityNew = new Especialidade
                {
                    Descricao = Descricao_,
                };
                _context.Especialidade.Add(entityNew);
            ...
            {
                int Id_ = Convert.ToInt32(txtId.Text);
                entityUpdate = _context.Especialidade.Find(Id_);
        ...
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Criar uma Nova Especialidade?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
