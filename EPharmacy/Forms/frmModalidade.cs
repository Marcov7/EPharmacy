...
namespace EPharmacy.Forms
{
    public partial class frmModalidade : Form
    {
        ...
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Excluir a Modalidade Selecionada?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
            ...
            var Delete = _context.Modalidade.Find(Id_);
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            var entityNew = new Modalidade();
            var entityUpdate = new Modalidade();

            if (txtId.Text.IsNullOrEmpty())
            {
                entityNew = new Modalidade
                {
                    Descricao = Descricao_,
                };
                _context.Modalidade.Add(entityNew);
            ...
            {
                int Id_ = Convert.ToInt32(txtId.Text);
                entityUpdate = _context.Modalidade.Find(Id_);
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var entidade = _context.Modalidade.AsQueryable();
