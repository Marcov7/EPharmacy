...
{
    public partial class frmPeriodicidadeRefil : Form
    {
        private readonly EPharmacyContext _context;
        private int Id;


        public frmPeriodicidadeRefil()
        {
            InitializeComponent();
        ...
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Excluir o Periodicidade Selecionado?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
            ...
            var Delete = _context.PeriodicidadeRefil.Find(Id_);
            ...
            if (Delete != null)
            {
                ...
                MessageBox.Show("Periodicidade excluído com sucesso!");
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            var entityNew = new PeriodicidadeRefil();
            var entityUpdate = new PeriodicidadeRefil();

            if (txtId.Text.IsNullOrEmpty())
            {
                entityNew = new PeriodicidadeRefil
                {
                    Descricao = Descricao_,
                };
                _context.PeriodicidadeRefil.Add(entityNew);
            ...
            {
                int Id_ = Convert.ToInt32(txtId.Text);
                entityUpdate = _context.PeriodicidadeRefil.Find(Id_);
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var entidade = _context.PeriodicidadeRefil.AsQueryable();
