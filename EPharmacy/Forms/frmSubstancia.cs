...
{
    public partial class frmSubstancia : Form
    {
        ...
        {
            DialogResult resultado = MessageBox.Show(
                "Você tem certeza que deseja Excluir a Substância Selecionada?",
                "Confirmação",
                MessageBoxButtons.YesNo,
                MessageBoxIcon.Question
            );
            ...
            var Delete = _context.Substancia.Find(Id_);
            ...
            if (Delete != null)
            {
                ...
                if (medicamento != null)
                {
                    MessageBox.Show("Substância não pode ser excluído. Tem dados relacionados entre Medicamento com Substância!");
                    return;
                }

                _context.Substancia.Remove(Delete);
                _context.SaveChangesAsync();
                MessageBox.Show("Substância excluído com sucesso!");
            ...
            {
                MessageBox.Show("Substância não encontrado.");
            }
        }
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            var entityNew = new Substancia();
            var entityUpdate = new Substancia();

            if (txtId.Text.IsNullOrEmpty())
            {
                entityNew = new Substancia
                {
                    Descricao = Descricao_,
                };
                _context.Substancia.Add(entityNew);
            ...
            {
                int Id_ = Convert.ToInt32(txtId.Text);
                entityUpdate = _context.Substancia.Find(Id_);
            ...
            MessageBox.Show(
                "Substância Gravada com sucesso",
                "",
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            ...
            var entidade = _context.Substancia.AsQueryable();
